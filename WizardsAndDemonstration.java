...
public class WizardsAndDemonstration {
	...
	Having considered the matter, the wizards decided to create clone puppets which can substitute the city people on the demonstration.

	So all in all, the demonstration will involve only the wizards and their puppets. 
	The city administration cannot tell the difference between a puppet and a person, so, as they calculate the percentage, 
	the administration will consider the city to be consisting of only n people and not containing any clone puppets.
	...
	The first line contains three space-separated integers, n, x, y (1²n,x,y²104,x²n) Ñ the number of citizens in the city, the number of wizards and the percentage the administration needs, correspondingly.
	...
	Print a single integer Ñ the answer to the problem, the minimum number of clones to create, 
